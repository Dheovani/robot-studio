...
public sealed record CartesianRobotProfile(Axis XAxis, Axis YAxis, Axis ZAxis) : IRobotProfile<CartesianPosition>
{
    public static CartesianRobotProfile CreateCartesian(
        Axis xAxis,
        Axis yAxis,
