...
{
    [Fact]
    public void Templates_ShouldExposeMechanicalShowcasesForCompletedRealisticModels()
    {
        ...
        Assert.Equal(
            ["Cartesian Robot", "XY Plotter", "Differential Drive Robot", "SCARA Robot", "Simple Articulated Arm"],
    ...
    public void Templates_WithAvailableGCodeMapping_ShouldExposeCapabilityBadge()
    {
        ...
        Assert.Equal(
            ["Cartesian Robot", "XY Plotter", "SCARA Robot", "Simple Articulated Arm", "Delta Robot", "6-DOF Industrial Arm"],
            gCodeTemplates);
    }
