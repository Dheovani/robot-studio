...
- exposes Cartesian Robot, XY Plotter, Differential Drive Robot, SCARA Robot, and Simple Articulated Arm as catalog models with mechanical showcases and resolves all five through the shared showcase catalog.
