...
- exposes Cartesian Robot, XY Plotter, Differential Drive Robot, and SCARA Robot as catalog models with mechanical showcases and resolves all four through the shared showcase catalog.
