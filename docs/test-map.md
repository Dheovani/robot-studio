...
- exposes Cartesian Robot, XY Plotter, Differential Drive Robot, SCARA Robot, Simple Articulated Arm, and Delta Robot as catalog models with mechanical showcases and resolves all six through the shared showcase catalog.
