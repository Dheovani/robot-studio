...
- exposes Cartesian Robot, XY Plotter, Differential Drive Robot, SCARA Robot, Simple Articulated Arm, Delta Robot, and Drone as catalog models with mechanical showcases and resolves all seven through the shared showcase catalog.
