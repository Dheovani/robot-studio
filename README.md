...
- Observe acceleration-aware Cartesian, XY plotter, Differential Drive, SCARA, Simple Articulated Arm, and 6-DOF Industrial Arm movement using triangular or trapezoidal velocity profiles.
